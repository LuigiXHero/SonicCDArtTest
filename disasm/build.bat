...
rem snasm68k.exe -emax 0 -p -o ae- s1comb.asm, SCD_Art_Test.bin
asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- sonic1.asm, SCD_Art_Test.bin
rompad.exe SCD_Art_Test.bin 255 0
fixheadr.exe SCD_Art_Test.bin
pause